...
class _EditJournalPageState extends State<EditJournalPage> {
  ...
  List<String> _existingImageUrls = []; // URL gambar yang sudah ada
  List<String> _newUploadedImageUrls = []; // URL gambar baru yang diupload
  List<Uint8List> _newImageBytes = []; // Preview gambar baru
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image:
                                            MemoryImage(_newImageBytes[index]),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
