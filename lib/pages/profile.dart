...
class ProfilePage extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              Column(
                ...
                children: [
                  // GENERAL
                  _sectionTitle(t['general']!, primary),
                  const SizedBox(height: 10),
                  _menuBox(primary: primary, children: [
                    _menuItem(
                  ...
                  // APPEARANCE
                  _sectionTitle(t['appearance']!, primary),
                  const SizedBox(height: 10),
                  _menuBox(primary: primary, children: [
                    _menuItem(
                  ...
                  // LANGUAGE SETTINGS
                  _sectionTitle(t['language_settings']!, primary),
                  const SizedBox(height: 10),
                  Container(
                  ...
                  // DATA & PRIVACY
                  _sectionTitle(t['data_privacy']!, primary),
                  const SizedBox(height: 10),
                  _menuBox(primary: primary, children: [
                    _menuItem(
  ...
  Widget _sectionTitle(String title, Color primary) => Text(title,
      style: GoogleFonts.poppins(
          fontSize: 16, fontWeight: FontWeight.bold, color: primary));

  Widget _menuBox({required Color primary, required List<Widget> children}) =>
      Container(
